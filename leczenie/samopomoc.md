...
Wielu osobom z depresją (i nie tylko) pomaga strukturyzacja dnia. Staraj się z góry zaplanować kolejny dzień, oczywiście na tyle na ile pozwala Ci dziecko (istnieją aplikacje, które mogą Ci w tym pomóc). Wypracowanie rutyny sprawi, że nie będziesz musiała za każdym razem zastanawiać się, jaki następny krok powinnaś wykonać. Nie wyznaczaj jednak sobie zbyt wielu celów oraz uwzględnij w planie przerwy. Staraj się również każdego dnia znaleźć odrobinę czasu tylko dla siebie, jak również odrobinę czasu, który spędzisz wyłącznie z partnerem. 
